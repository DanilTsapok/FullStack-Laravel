...
<body> 
    <header>
    @auth 
        <h1><img style="width: 30px" src="https://img.icons8.com/?size=80&id=65012&format=png" alt="" srcset=""><a class="homeroute"href="{{route('home')}}">PizzaPage</a></h1>
        <div class="nav-link">
        <div style="display: flex; gap: 10px;">
            <img width="20" height="20" src="https://img.icons8.com/color/48/gender-neutral-user.png" alt="gender-neutral-user"/>
        ...
        <a href="{{route('logout')}}" ><img width="25" height="25" src="https://img.icons8.com/ios/50/FAB005/exit--v1.png" alt="exit--v1"/></a>
    @else 
    <h1><img style="width: 30px" src="https://img.icons8.com/?size=80&id=65012&format=png" alt="" srcset="">PizzaPage</h1>
