...
<header>
    ...
    <div class="nav-link">
        <nav>
            ...
            <a href="/" >
                <img width="25" height="25" src="https://img.icons8.com/fluency-systems-regular/48/FFFFFF/home--v1.png" alt="home--v1"/>
            </a>
            @else
            <a href="/" >
        ...
        @auth
            ...
            @if(Route::currentRouteName() === 'profileView')
                <a href="/profile" >
                    <img width="25" height="25" src="https://img.icons8.com/windows/32/FFFFFF/gender-neutral-user.png" alt="gender-neutral-user"/>
                </a>
            @else
                <a href="/profile" >
                    <img width="25" height="25" src="https://img.icons8.com/windows/32/565656/gender-neutral-user.png" alt="gender-neutral-user"/>
                </a>
            @endif
        @endauth
            <a href="">
                <img width="25" height="25" src="https://img.icons8.com/ios-glyphs/30/565656/search--v1.png" alt="search--v1"/>
            </a>
        </nav>
    </div>
    <div>
        @auth
        <a href="{{ route('logout') }}">
            <img width="25" height="25" src="https://img.icons8.com/ios/50/FFFFFF/exit--v1.png" alt="Exit"/>
        </a>
        @endauth
    </div>
</header> 
